...
<body>
    ...
    <div class="box">
        ...
        <p class="box-text">Quản lý thành viên</p>
        <div>
    ...
    <div class="content">
        ...
        <div class="content-box">
            ...
            function fetchmemberData(search = '') {
                var xhr = new XMLHttpRequest();
                xhr.open("POST", 'database_scripts/get_member_data.php', true);
            ...
            // Fetch all member data when the page loads
            fetchmemberData();
            
            // Fetch member data based on search when the form is submitted
            document.getElementById('searchForm').addEventListener('submit', function(e) {
                e.preventDefault();
                var search = document.getElementById('search').value;
                if (search === '') {
                    // If the search term is blank, fetch all member data
                    fetchmemberData();
                } else {
                    fetchmemberData(search);
                }
            });
            </script>
